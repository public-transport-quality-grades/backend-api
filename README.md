...
6. If you did everything correct, https://public-transport-quality-grades.github.io/backend-api/ will lead to your new docs
...
- Preview spec version for branch `[branch]`: https://public-transport-quality-grades.github.io/backend-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://public-transport-quality-grades.github.io/backend-api/ with url from the message: `Server started <url>`
